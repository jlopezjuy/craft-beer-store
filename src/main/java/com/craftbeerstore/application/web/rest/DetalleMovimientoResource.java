...
/**
 * REST controller for managing {@link com.craftbeerstore.application.domain.DetalleMovimiento}.
 */
@RestController
@RequestMapping("/api")
public class DetalleMovimientoResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new detalleMovimientoDTO, or with status {@code 400 (Bad Request)} if the detalleMovimiento has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated detalleMovimientoDTO,
     * or with status {@code 400 (Bad Request)} if the detalleMovimientoDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the detalleMovimientoDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<DetalleMovimientoDTO> updateDetalleMovimiento(@Valid @RequestBody DetalleMovimientoDTO detalleMovimientoDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, detalleMovimientoDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the detalleMovimientoDTO, or with status {@code 404 (Not Found)}.
     */
