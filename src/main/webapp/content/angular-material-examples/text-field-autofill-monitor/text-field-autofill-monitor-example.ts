...
export class TextFieldAutofillMonitorExample implements OnDestroy, OnInit {
    ...
    ngOnInit() {
        this.autofill.monitor(this.firstName).subscribe(e => (this.firstNameAutofilled = e.isAutofilled));
        this.autofill.monitor(this.lastName).subscribe(e => (this.lastNameAutofilled = e.isAutofilled));
    }
