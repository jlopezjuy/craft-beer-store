...
export class PageGalleryComponent implements OnDestroy {
  ...
  public _albumsTab1: Array<NgxGalleryImage> = new Array<NgxGalleryImage>();
  public _albumsTab2: Array<NgxGalleryImage> = new Array<NgxGalleryImage>();
  public _albumsTab3: Array<NgxGalleryImage> = new Array<NgxGalleryImage>();
  public _albumsTab4: Array<NgxGalleryImage> = new Array<NgxGalleryImage>();
