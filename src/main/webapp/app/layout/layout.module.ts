...
import { CraftBeerStoreSharedCommonModule, CraftBeerStoreSharedModule } from '../shared';

@NgModule({
  imports: [CommonModule, NgbModule, RouterModule, CraftBeerStoreSharedCommonModule, CraftBeerStoreSharedModule],
