...
@Component({
    selector: 'jhi-e-commerce-orders',
...
export class FilesDataSource extends DataSource<any> {
     ...
     */
    constructor(private _ecommerceOrdersService: EcommerceOrdersService, private _matPaginator: MatPaginator, private _matSort: MatSort) {
        super();
