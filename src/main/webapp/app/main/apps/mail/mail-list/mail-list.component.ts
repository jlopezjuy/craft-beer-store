...
export class MailListComponent implements OnInit, OnDestroy {
     ...
     */
    constructor(private _activatedRoute: ActivatedRoute, private _mailService: MailService, private _location: Location) {
    ...
    ngOnInit(): void {
        ...
        this._mailService.onMailsChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(mails => {
            this.mails = mails;
        });
