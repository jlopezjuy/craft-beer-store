...
@Component({
    selector: 'jhi-mail-main-sidebar',
...
export class MailMainSidebarComponent implements OnInit, OnDestroy {
     ...
     */
    constructor(private _mailService: MailService, public _matDialog: MatDialog) {
        // Set the defaults
        this.accounts = {
    ...
    ngOnInit(): void {
        ...
        this._mailService.onFiltersChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(filters => {
