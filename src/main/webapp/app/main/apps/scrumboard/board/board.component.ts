...
export class ScrumboardBoardComponent implements OnInit, OnDestroy {
    ...
    constructor(private _activatedRoute: ActivatedRoute, private _location: Location, private _scrumboardService: ScrumboardService) {
