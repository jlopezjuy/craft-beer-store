...
export class SearchClassicComponent implements OnInit, OnDestroy {
     ...
     */
    constructor(private _searchClassicService: SearchClassicService) {
     ...
     */
    ngOnInit(): void {
        this._searchClassicService.dataOnChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(searchItems => {
