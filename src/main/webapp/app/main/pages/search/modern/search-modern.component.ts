...
export class SearchModernComponent implements OnInit, OnDestroy {
     ...
     */
    constructor(private _searchModernService: SearchModernService) {
     ...
     */
    ngOnInit(): void {
        this._searchModernService.dataOnChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(searchItems => {
