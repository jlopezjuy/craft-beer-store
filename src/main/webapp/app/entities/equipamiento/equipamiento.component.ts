...
export class EquipamientoComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.equipamientoService
      ...
      .subscribe((res: HttpResponse<IEquipamiento[]>) => this.paginateEquipamientos(res.body, res.headers));
  }
  ...
  registerChangeInEquipamientos() {
    this.eventSubscriber = this.eventManager.subscribe('equipamientoListModification', () => this.loadAll());
  }

  delete(equipamiento: IEquipamiento) {
    const modalRef = this.modalService.open(EquipamientoDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.equipamiento = equipamiento;
  }
