...
export class RecetaComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.recetaService
      ...
      .subscribe((res: HttpResponse<IReceta[]>) => this.paginateRecetas(res.body, res.headers));
  }
  ...
  registerChangeInRecetas() {
    this.eventSubscriber = this.eventManager.subscribe('recetaListModification', () => this.loadAll());
  }

  delete(receta: IReceta) {
