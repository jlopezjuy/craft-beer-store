...
export class EventoProductoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.eventoProductoService
                ...
                .subscribe(
                    (res: HttpResponse<IEventoProducto[]>) => this.paginateEventoProductos(res.body, res.headers),
    ...
    registerChangeInEventoProductos() {
        this.eventSubscriber = this.eventManager.subscribe('eventoProductoListModification', response => this.loadAll());
    }
