...
export class EventoProductoService {
    ...
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/evento-productos';
    ...
    queryByEvento(eventoId: number): Observable<EntityArrayResponseType> {
        return this.http.get<IEventoProducto[]>(`${this.resourceUrl}/evento/${eventoId}`, { observe: 'response' });
    }
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IEventoProducto[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
