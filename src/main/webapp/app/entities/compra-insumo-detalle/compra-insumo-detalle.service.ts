...
export class CompraInsumoDetalleService {
  ...
  findAllByCompraInsumo(compraInsumoId: number): Observable<EntityArrayResponseType> {
    return this.http.get<ICompraInsumoDetalle[]>(`${this.resourceUrl}/compra-insumo/${compraInsumoId}`, { observe: 'response' });
  }
