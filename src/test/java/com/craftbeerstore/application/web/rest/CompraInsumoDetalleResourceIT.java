...
/**
 * Integration tests for the {@link CompraInsumoDetalleResource} REST controller.
 */
@SpringBootTest(classes = CraftBeerStoreApp.class)
public class CompraInsumoDetalleResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CompraInsumoDetalle createUpdatedEntity(EntityManager em) {
        CompraInsumoDetalle compraInsumoDetalle = new CompraInsumoDetalle()
