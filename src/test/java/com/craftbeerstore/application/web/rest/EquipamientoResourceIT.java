...
/**
 * Integration tests for the {@link EquipamientoResource} REST controller.
 */
@SpringBootTest(classes = CraftBeerStoreApp.class)
public class EquipamientoResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static Equipamiento createUpdatedEntity(EntityManager em) {
        Equipamiento equipamiento = new Equipamiento()
    ...
    public void getEquipamiento() throws Exception {
        ...
        restEquipamientoMockMvc.perform(get("/api/equipamientos/{id}", equipamiento.getId()))
            ...
            .andExpect(jsonPath("$.nombreEquipamiento").value(DEFAULT_NOMBRE_EQUIPAMIENTO))
