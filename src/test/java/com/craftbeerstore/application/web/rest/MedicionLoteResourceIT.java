...
/**
 * Integration tests for the {@link MedicionLoteResource} REST controller.
 */
@SpringBootTest(classes = CraftBeerStoreApp.class)
public class MedicionLoteResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static MedicionLote createUpdatedEntity(EntityManager em) {
        MedicionLote medicionLote = new MedicionLote()
            .dia(UPDATED_DIA)
