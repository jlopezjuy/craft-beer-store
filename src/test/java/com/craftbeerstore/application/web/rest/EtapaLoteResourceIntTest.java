...
/**
 * Test class for the EtapaLoteResource REST controller.
 *
 * @see EtapaLoteResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = CraftBeerStoreApp.class)
public class EtapaLoteResourceIntTest {
    ...
    public void testEntityFromId() {
        assertThat(etapaLoteMapper.fromId(42L).getId()).isEqualTo(42);
