...
/**
 * Integration tests for the {@link CompraInsumoResource} REST controller.
 */
@SpringBootTest(classes = CraftBeerStoreApp.class)
public class CompraInsumoResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CompraInsumo createUpdatedEntity(EntityManager em) {
        CompraInsumo compraInsumo = new CompraInsumo()
