...
/**
 * Test class for the MovimientoBarrilResource REST controller.
 *
 * @see MovimientoBarrilResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = CraftBeerStoreApp.class)
public class MovimientoBarrilResourceIntTest {
    ...
    public void testEntityFromId() {
        assertThat(movimientoBarrilMapper.fromId(42L).getId()).isEqualTo(42);
