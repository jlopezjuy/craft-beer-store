...
/**
 * Integration tests for the {@link MovimientoTanqueResource} REST controller.
 */
@SpringBootTest(classes = CraftBeerStoreApp.class)
public class MovimientoTanqueResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static MovimientoTanque createUpdatedEntity(EntityManager em) {
        MovimientoTanque movimientoTanque = new MovimientoTanque()
            .fecha(UPDATED_FECHA)
