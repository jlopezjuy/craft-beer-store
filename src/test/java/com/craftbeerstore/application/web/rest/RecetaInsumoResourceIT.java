...
/**
 * Integration tests for the {@link RecetaInsumoResource} REST controller.
 */
@SpringBootTest(classes = CraftBeerStoreApp.class)
public class RecetaInsumoResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static RecetaInsumo createUpdatedEntity(EntityManager em) {
        RecetaInsumo recetaInsumo = new RecetaInsumo()
