...
describe('Service Tests', () => {
    describe('Receta Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Receta', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        fecha: currentDate.format(DATE_FORMAT)
            ...
            it('should update a Receta', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB',
                        brewMaster: 'BBBBBB',
                        batch: 1,
                        temperaturaDeMacerado: 1,
                        og: 1,
                        fg: 1,
                        abv: 1,
                        ibu: 1,
            ...
            it('should return a list of Receta', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB',
                        brewMaster: 'BBBBBB',
            ...
            it('should delete a Receta', async () => {
