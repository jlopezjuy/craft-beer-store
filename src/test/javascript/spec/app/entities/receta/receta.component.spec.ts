...
import { RecetaComponent } from 'app/entities/receta/receta.component';
import { RecetaService } from 'app/entities/receta/receta.service';
import { Receta } from 'app/shared/model/receta.model';

describe('Component Tests', () => {
    describe('Receta Management Component', () => {
        let comp: RecetaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RecetaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.recetas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
