...
import { PresentacionComponent } from 'app/entities/presentacion/presentacion.component';
...
describe('Component Tests', () => {
  describe('Presentacion Management Component', () => {
    let comp: PresentacionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PresentacionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.presentacions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
