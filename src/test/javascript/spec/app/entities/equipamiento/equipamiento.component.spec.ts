...
import { EquipamientoComponent } from 'app/entities/equipamiento/equipamiento.component';
...
describe('Component Tests', () => {
  describe('Equipamiento Management Component', () => {
    let comp: EquipamientoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EquipamientoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.equipamientos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
