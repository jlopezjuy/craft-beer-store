...
import { EstilosComponent } from 'app/entities/estilos/estilos.component';
import { EstilosService } from 'app/entities/estilos/estilos.service';
import { Estilos } from 'app/shared/model/estilos.model';

describe('Component Tests', () => {
    describe('Estilos Management Component', () => {
        let comp: EstilosComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EstilosComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.estilos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
