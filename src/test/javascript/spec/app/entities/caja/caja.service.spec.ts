...
import { ICaja, Caja, TipoMovimientoCaja, TipoPago } from 'app/shared/model/caja.model';
...
describe('Service Tests', () => {
    describe('Caja Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Caja(0, TipoMovimientoCaja.INGRESO, TipoPago.EFECTIVO, 'AAAAAAA', 0, 0, currentDate);
        });
