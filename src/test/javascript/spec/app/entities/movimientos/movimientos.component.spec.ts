...
import { MovimientosComponent } from 'app/entities/movimientos/movimientos.component';
...
describe('Component Tests', () => {
  describe('Movimientos Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.movimientos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
