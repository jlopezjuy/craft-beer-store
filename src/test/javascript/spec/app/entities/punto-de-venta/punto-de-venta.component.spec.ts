...
import { PuntoDeVentaComponent } from 'app/entities/punto-de-venta/punto-de-venta.component';
...
describe('Component Tests', () => {
    describe('PuntoDeVenta Management Component', () => {
        let comp: PuntoDeVentaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PuntoDeVentaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.puntoDeVentas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
