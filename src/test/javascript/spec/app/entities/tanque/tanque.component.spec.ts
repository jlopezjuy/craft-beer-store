...
import { TanqueComponent } from 'app/entities/tanque/tanque.component';
import { TanqueService } from 'app/entities/tanque/tanque.service';
import { Tanque } from 'app/shared/model/tanque.model';

describe('Component Tests', () => {
  describe('Tanque Management Component', () => {
    let comp: TanqueComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TanqueComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.tanques[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
