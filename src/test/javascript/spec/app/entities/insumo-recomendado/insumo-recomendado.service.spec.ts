...
describe('Service Tests', () => {
    describe('InsumoRecomendado Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a InsumoRecomendado', async () => {
            ...
            it('should update a InsumoRecomendado', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB',
                        marca: 'BBBBBB'
            ...
            it('should return a list of InsumoRecomendado', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB',
                        marca: 'BBBBBB'
            ...
            it('should delete a InsumoRecomendado', async () => {
